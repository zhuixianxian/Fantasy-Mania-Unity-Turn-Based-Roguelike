...
public class BinaryDataMgr:BaseManager<BinaryDataMgr>
{
    ...
    public void LoadTable<T,K>()
    {
        ...
        using (FileStream fs = File.Open(DATA_BINARY_PATH + typeof(K).Name + ".ZhuiXian", FileMode.Open, FileAccess.Read))
        {
    ...
    public void Save(object obj, string fileName)
    {
        ...
        using (FileStream fs = new FileStream(SAVE_PATH + fileName + ".ZhuiXian", FileMode.OpenOrCreate, FileAccess.Write))
        {
    ...
    public T Load<T>(string fileName) where T:class
    {
        ...
        if( !File.Exists(SAVE_PATH + fileName + ".ZhuiXian") )
            return default(T);

        T obj;
        using (FileStream fs = File.Open(SAVE_PATH + fileName + ".ZhuiXian", FileMode.Open, FileAccess.Read))
        {
            BinaryFormatter bf = new BinaryFormatter();
