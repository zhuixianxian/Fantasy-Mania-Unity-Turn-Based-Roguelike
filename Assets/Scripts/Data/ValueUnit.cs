...
namespace FantasyMania.TurnBasedCombat
{
    ...
    public class ValueUnit
    {
        ...
        /// 单位
        /// </summary>
        public GameEnums.UnitType Unit;
        ...
        public ValueUnit(string temp)
        {
            ...
            if (strs.Length == 2)
            {
                ...
                this.Unit = (GameEnums.UnitType)int.Parse(strs[1]);
            }
            else
            {
                this.Value = 0;
                this.Unit = GameEnums.UnitType.Value;
            }
        }
        ...
        public ValueUnit(long v, GameEnums.UnitType u)
        {
            this.Value = v;
            this.Unit = u;
        }
        ...
        {
            this.Value = v;
            this.Unit = (GameEnums.UnitType)int.Parse(u);
        }
        ...
        {
            this.Value = v;
            this.Unit = (GameEnums.UnitType)u;
        }
        ...
        {
            if (Unit == GameEnums.UnitType.Percent)
            {
                result = Value / 100f;
                return true;
            }
        ...
        {
            if (Unit == GameEnums.UnitType.Value)
            {
                result = Value;
                return true;
            }
        ...
        public long RealValue(long baseValue)
        {
            ...
            else if (Unit == GameEnums.UnitType.Percent)
            {
